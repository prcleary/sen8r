...
dept_uid <- dept_lookup(
  values = "Microbiology",
  from = "title",
  to = "uid"
)

serum_uid <- sampletype_lookup(
  values = "Serum",
  from = "title",
  to = "uid"
)
...
multiple_uids <- dept_lookup(
  values = c("Microbiology", "Hematology", "Chemistry"),
  from = "title",
  to = "uid"
)
```
...
lft_category_uid <- category_lookup(
  values = "LFT",
  from = "title",
  to = "uid"
)
...
sampletype_lookup <- senaite_lookup('sampletype')
serum_uid <- sampletype_lookup(values = "Serum", from = "title", to = "uid")
...
dept_lookup <- senaite_lookup('department')
microbiology_uid <- dept_lookup(values = "Microbiology", from = "title", to = "uid")
...
lft_category_uid <- category_lookup(values = "LFT", from = "title", to = "uid")
method_uids <- method_lookup(
  values = c("PCR", "ELISA"),
  from = "title",
  to = "uid"
